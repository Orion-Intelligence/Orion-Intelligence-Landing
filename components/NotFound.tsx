...
const NotFound: React.FC<NotFoundProps> = ({ onBack }) => {
  return (
    <div className="relative min-h-screen flex flex-col p-8 md:p-16 lg:p-24 bg-slate-50 dark:bg-[#050507] text-slate-700 dark:text-slate-300 font-sans selection:bg-red-500/30">
      ...
      <div className="flex items-center justify-between mb-24 animate-in fade-in slide-in-from-top-4 duration-700">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-white/40 shadow-sm dark:shadow-none">
            <ShieldAlert className="w-5 h-5" />
          </div>
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-[0.4em]">Status_Code: 404</span>
      ...
      <div className="grid lg:grid-cols-2 gap-20 items-start max-w-6xl">
        <div className="space-y-10 animate-in fade-in slide-in-from-left-6 duration-1000">
          <div className="space-y-6">
            <h1 className="text-[10rem] md:text-[12rem] font-black text-slate-900 dark:text-white leading-none tracking-tighter italic opacity-90 select-none">
              404
            </h1>
            <div className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white uppercase tracking-tight">Endpoint Not Found</h2>
          ...
          <div className="pt-4">
            <button 
              onClick={onBack}
              className="group relative px-10 py-5 bg-slate-900 dark:bg-white text-white dark:text-black rounded-2xl font-black text-[11px] uppercase tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-slate-800 dark:hover:bg-slate-100 transition-all active:scale-95 shadow-2xl overflow-hidden"
            >
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-right-6 duration-1000 delay-200">
          <div className="p-8 rounded-3xl bg-white/80 dark:bg-black/40 border border-slate-200 dark:border-white/5 backdrop-blur-xl shadow-xl dark:shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-1 h-full bg-red-500/20 group-hover:bg-red-500/50 transition-colors"></div>
            
            <div className="flex items-center gap-3 mb-8 border-b border-slate-200 dark:border-white/5 pb-4">
              <Terminal className="w-4 h-4 text-slate-400 dark:text-white/20" />
              <span className="text-[10px] font-black text-slate-500 dark:text-white/40 uppercase tracking-widest">Trace_Dump</span>
            </div>
            
            <div className="space-y-6 font-mono text-[10px] text-slate-500 dark:text-slate-400">
              <div className="space-y-2">
                <p className="text-[8px] font-bold text-slate-400 dark:text-white/20 uppercase">Core Data</p>
              ...
              <div className="space-y-2 pt-4 border-t border-slate-200 dark:border-white/5">
                <p className="text-[8px] font-bold text-slate-400 dark:text-white/20 uppercase flex items-center gap-2">
          ...
          <div className="px-6 py-4 rounded-2xl bg-white/80 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 flex items-center gap-4 group shadow-sm dark:shadow-none">
      ...
      {/* Simple Footer */}
      <div className="mt-auto pt-24 border-t border-slate-200 dark:border-white/5 flex items-center justify-between opacity-30 dark:opacity-20">
